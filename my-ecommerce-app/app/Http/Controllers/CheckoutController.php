...
use Gloudemans\Shoppingcart\Facades\Cart; // <-- Add this import Module 6
use Illuminate\Support\Facades\Auth; // <-- Add this import Module 6
use Illuminate\Support\Facades\DB; // <-- Add this import Module 6
use App\Models\Order; // <-- Add this import Module 6
use App\Models\Product; // <-- Add this import Module 6
