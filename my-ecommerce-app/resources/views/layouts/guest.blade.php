    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <a href="{{ route('cart.index') }}" class="ms-4 me-4 text-sm font-medium text-gray-600 hover:text-gray-900">
                    Cart ({{ Cart::count() }}) </a>
                ...
                @if (Route::has('login'))
                    ...
                    @else
                        <a href="{{ route('login') }}" class="ms-4 text-sm font-medium text-gray-600 hover:text-gray-900">Log in</a>
